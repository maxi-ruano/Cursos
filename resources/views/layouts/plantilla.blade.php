...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        ...
                        <p class="text  mb-4 mb-lg-0">&copy; ONLINE PROGRAMMING 2022. All Rights Reserved.</p>
                    </div>
                    <div class="col-lg-13 h-100 text-center text-lg-end my-auto">
        ...
        {{-- <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="high text-center ">Copyright &copy; 2022 - Online Programming</div></div>
        </footer> --}}
    </body>
